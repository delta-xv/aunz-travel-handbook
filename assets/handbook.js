...
function weatherContent(target,result){
 ...
 const city=cities[target.city],today=dateKey(new Date()),isToday=target.date===today;
 const link=wikiLink(city[0],true,weatherCityLabel(target.city));
 let body='';
 if(has){
